...
from app.models.enums import ApprovalStatus, ExecutionMode, IntentType, MissionStatus, ModelMode, PolicyDecision, RiskLevel, StrategyType
...
class UniversalMissionCreate(BaseModel):
    project_id: UUID = Field(default_factory=uuid4)
